<template>
  <div class="player" v-show="playlist.length>0">
    ...
    <audio ref="audio" :src="currentSong.mid && 'http://ws.stream.qqmusic.qq.com/C100'+currentSong.mid+'.m4a?fromtag=46'" @canplay="ready"
           @error="error"
...
//          this.resetCurrentIndex(list);
      ...
      handleLyric({lineNum,txt}){
          ...
          if(lineNum>5){
            ...
            let a=this.$refs.lyricLine[0];
            this.$refs.lyricList.scrollToElement(a,1000);
          }
      ...
      resetCurrentIndex(list){
          let index=list.findIndex((item)=>{
              return item.provide===this.currentSong.id
          })
          this.setCurrentIndex(index);
      },
      _pad(num,n=2){
